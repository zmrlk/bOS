---
name: Learn Path
description: "AI-powered learning roadmap — define what you want to learn, get a phased plan with resources, track progress through milestones. Use when user wants to start learning a new skill, topic, or language with a structured roadmap."
user_invocable: true
command: /learn-path
---
