...
- `state/daily-log.md` (**FULL file, not just Summary**) — energy trends this week (14d window). **CRITICAL: Always count raw energy entries from the Active table. Do NOT trust the Summary section for energy counts or averages — recalculate from raw data every time.**
