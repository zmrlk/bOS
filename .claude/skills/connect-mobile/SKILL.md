---
name: Connect Mobile
description: "Set up phone access to bOS — via Remote Control (native, simple) or Telegram (advanced, works independently). Adapted to tech comfort. Use once to set up mobile access to bOS, or when user mentions phone, mobile, or remote access."
user_invocable: true
