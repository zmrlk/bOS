---
name: Money Flow
description: "Cash flow visualization — see where your money goes with an ASCII waterfall chart. Income → expenses → savings → buffer. Use to visualize monthly cash flow, identify spending patterns, or review financial health."
user_invocable: true
command: /money-flow
---
