---
name: Delete Data
description: "Delete all personal data from bOS. Resets profile, state files, and agent memory. Use only when user explicitly requests to delete all personal data or reset bOS completely."
user_invocable: true
