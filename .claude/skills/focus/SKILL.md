---
name: Focus
description: "Deep work session manager — pick a task, set a timer, log completion. ADHD-friendly focus tool. Use when starting deep work or needing focus discipline. ADHD-friendly timer with completion logging."
user_invocable: true
command: /focus
---
