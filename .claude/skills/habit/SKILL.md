---
name: Habit
description: "Standalone habit manager — view streaks, add/remove habits, log completions. Gamified with milestones and personal bests. Use daily to log habit completions, view streak progress, or manage habit list."
user_invocable: true
command: /habit
---
