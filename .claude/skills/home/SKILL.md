---
name: Home
description: "Dashboard — one screen with everything that matters right now. Tasks, energy, streaks, buffer, calendar, next action. Use at any time for quick situational awareness, or when user says /home, dashboard, or status."
user_invocable: true
command: /home
---
